...
def get_function_signature(code_string):
    ...
    #! Creating an abstract sytax tree module allows for manipulation and analysis of the code
    ...
    #! Results in a fn signature of the form function_name(self.arg1, self.arg2, ...)
